    ...
    null !== t &&
      ...
      'horizontal' === t
        ? (document.querySelector('.pc-sidebar').classList.add('d-none'),
          (e.src = '/admin_asset/js/layout-horizontal.js'),
          document.body.appendChild(e))
        : 'color-header' === t
        ? document.querySelector('.pc-sidebar .m-header .logo-lg') &&
          document.querySelector('.pc-sidebar .m-header .logo-lg')
        : // .setAttribute('src', '/admin_asset/images/logo-white.svg')
        'compact' === t
        ? ((e.src = '/admin_asset/js/layout-compact.js'),
          document.body.appendChild(e))
        : 'tab' === t &&
          ((e.src = '/admin_asset/js/layout-tab.js'),
          document.body.appendChild(e))),
    null === t &&
